= MicroProfile Showcase Application image:https://travis-ci.org/OpenLiberty/sample-mpconf.svg?branch=master["Build Status", link="https://travis-ci.org/OpenLiberty/sample-mpconf"]
